...
KNOWN_INS = (ArrayIn, IntIn, FloatIn, StrIn, NoneIn, GenericIn)
KNOWN_OUTS = (ArrayOut, IntOut, FloatOut, StrOut, NoneOut, GenericOut)
...
if __name__ == "__main__":
    ...
    def eval_axis(axis, vals, real):
        ...
        var_string = '   (' + ', '.join(['{}={}'.format(i, j)
                                         for i, j in zip(axis.varnames, vals)]) + ')' if len(vals) else ''
