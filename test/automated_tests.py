...
def test_imageloader_resizer_color2gray_orb_pipeline():
    import imsciutils as iu
    import numpy as np
    testing_printer = iu.get_printer('test->imageloader->resizer->color2gray->orb->pipeline')
    ORB_KEYPOINTS = 10
    ...
    pipeline = iu.Pipeline(name='test->imageloader->resizer->color2gray->orb->pipeline',
